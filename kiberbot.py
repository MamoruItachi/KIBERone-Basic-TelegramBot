...
def get_text_messages(message):
    ...
    #ОПЛАТА
        ...
        btn2 = types.KeyboardButton('оплата по ссылке')
        btn3 = types.KeyboardButton('оплата по QR-коду')
        btn4 = types.KeyboardButton('оплата прямо из Telegram')
        ...
        bot.send_photo(message.chat.id, open('resource/QR_code_payment.jpg', 'rb'), '\n\n'.join(caption))
